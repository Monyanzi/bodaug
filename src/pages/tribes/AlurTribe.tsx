          ...
          <Tabs defaultValue="overview" className="space-y-8">
            ...
            <TabsContent value="overview">
              <div className="text-center py-16">
                ...
                <p className="text-muted-foreground mt-2">
                  Detailed information about the Alur tribe is being prepared.
                </p>
              </div>
            </TabsContent>
            <TabsContent value="clothing">
              <div className="text-center py-16">
                <h3 className="text-2xl font-semibold text-foreground">Content Coming Soon</h3>
                <p className="text-muted-foreground mt-2">
                  Detailed information about Alur clothing is being prepared.
                </p>
              </div>
            </TabsContent>
            <TabsContent value="food">
              <div className="text-center py-16">
                <h3 className="text-2xl font-semibold text-foreground">Content Coming Soon</h3>
                <p className="text-muted-foreground mt-2">
                  Detailed information about Alur food is being prepared.
                </p>
              </div>
            </TabsContent>
            <TabsContent value="traditions">
              <div className="text-center py-16">
                <h3 className="text-2xl font-semibold text-foreground">Content Coming Soon</h3>
                <p className="text-muted-foreground mt-2">
                  Detailed information about Alur traditions is being prepared.
                </p>
              </div>
            </TabsContent>
            <TabsContent value="names">
              <div className="text-center py-16">
                <h3 className="text-2xl font-semibold text-foreground">Content Coming Soon</h3>
                <p className="text-muted-foreground mt-2">
                  Detailed information about Alur names is being prepared.
                </p>
              </div>
            </TabsContent>
            <TabsContent value="places">
              <div className="text-center py-16">
                <h3 className="text-2xl font-semibold text-foreground">Content Coming Soon</h3>
                <p className="text-muted-foreground mt-2">
                  Detailed information about Alur places is being prepared.
                </p>
              </div>
            </TabsContent>
          </Tabs>
