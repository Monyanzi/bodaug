        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <a 
              ...
              className="inline-flex items-center space-x-2 text-sm md:text-base text-muted-foreground hover:text-accent transition-colors duration-200 boda-underline"
            >
